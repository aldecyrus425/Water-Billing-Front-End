...
const Header = ({sidebarCollapsed, onToggleSidebar, currentPage} : Props) => {
    return (
            ...
            <div className='flex items-center justify-between'>
                ...
                <div className='flex-1 max-w-md mx-8'>
                    <div className='relative'>
                        ...
                        <input type="text" placeholder='Search Anything' className='w-full pl-10 pr-2.5 py-2.5 bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-slate-800 dark:text-white placeholder-slate-500 focus:outline-none focus:rign-2 focus:ring-blue-500 focus:border-transparent transition-all' />
